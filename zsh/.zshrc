...
alias ll='ls -al'
alias src='cd $HOME/src/github/basis-theory'
alias zshedit='code $HOME/.zshrc'
alias zshsource='source $HOME/.zshrc'
alias aws-login='aws sso login --sso-session BasisTheory'

# Support nvm CLI for managing versions of node
export NVM_DIR="$HOME/.nvm"
  [ -s "/opt/homebrew/opt/nvm/nvm.sh" ] && \. "/opt/homebrew/opt/nvm/nvm.sh"  # This loads nvm
  [ -s "/opt/homebrew/opt/nvm/etc/bash_completion.d/nvm" ] && \. "/opt/homebrew/opt/nvm/etc/bash_completion.d/nvm"  # This loads nvm bash_completion

# Support pyenv CLI for managing versions of python
eval "$(pyenv init --path)"

# Support asdf as a version manager for multiple CLIs
